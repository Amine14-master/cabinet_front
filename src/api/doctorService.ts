...
export const updateDoctorProfile = async (doctorData: DoctorProfileUpdate) => {
  try {
    ...
    const response = await api.put('doctors/profile/update/', formData, {
      headers: {
    ...
    throw error.response?.data || 'Erreur lors de la mise à jour du profil médecin'
  }
}
