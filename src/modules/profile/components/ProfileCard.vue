    ...
    <div class="p-5 mb-6 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          <div
            class="relative w-20 h-20 overflow-hidden rounded-full border border-gray-200 dark:border-gray-800"
          >
            <img
          ...
          <div class="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
            <button class="edit-button" @click="isProfilePhotoModal = true">
              <svg
                class="fill-current"
                width="18"
                height="18"
      ...
      <Modal v-if="isProfilePhotoModal" @close="isProfilePhotoModal = false">
        <template #body>
          <div class="relative w-full max-w-md rounded-3xl bg-white p-6 dark:bg-gray-900">
            <button @click="isProfilePhotoModal = false" class="absolute right-5 top-5">✕</button>

            <h4 class="mb-6 text-xl font-semibold">Modifier la photo de profil</h4>
