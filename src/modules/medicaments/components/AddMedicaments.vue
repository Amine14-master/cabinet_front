    ...
    >
      <div class="max-w-full overflow-x-auto custom-scrollbar">
        <form @submit.prevent="handleSubmit" class="grid grid-cols-1 gap-6 p-4">
          ...
          <div
            class="bg-white dark:bg-white/[0.03] rounded-3xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm"
          >
            <div class="flex items-center gap-3 mb-6">
              <div
                class="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-600"
              >
                <svg
            ...
            <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-2 md:col-span-2">
                ...
                >
                <div
                  class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-4"
                >
                  <div class="flex items-center gap-4">
                    <div
                      class="w-14 h-14 rounded-xl bg-blue-600 flex items-center justify-center text-white text-xl font-bold shadow-lg"
                    >
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-500 dark:text-gray-400">
                        Code: {{ appointmentData?.patient_code }}
                      </p>
                      <p class="text-sm text-gray-500 dark:text-gray-400">
              ...
              <div class="space-y-2">
                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1"
                  >Code Rendez-vous</label
                >
                <div
                  class="p-3.5 rounded-2xl bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700"
                >
                ...
                >
                  <span
                    :class="[
                      ...
                      appointmentData?.period === 'morning'
              ...
              <div class="space-y-2">
                ...
                >
                  <span
                    class="inline-flex px-2 py-1 rounded-full text-xs font-bold bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-400"
                  >
                    {{
